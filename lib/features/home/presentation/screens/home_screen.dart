...
class HomeScreen extends StatelessWidget {
  ...
  Widget _buildFeatureCard(BuildContext context,
    ...
    return Container(
      decoration: BoxDecoration(
        // Remove color from here, as it's handled by Material
    ...
    return Column(
      ...
      children: [
        ...
        _buildActivityItem(
            ...
            subtitle:
                '${'hours_ago'.tr(namedArgs: {'hours': '2'})} • ${'min_duration'.tr(namedArgs: {'minutes': '5'})}'),
        _buildActivityItem(
            context: context,
            icon: Icons.mic,
            title: 'voice_to_avatar_session'.tr(),
            subtitle:
                '${'yesterday'.tr()} • ${'min_duration'.tr(namedArgs: {'minutes': '3'})}'),
        _buildActivityItem(
            context: context,
            icon: Icons.videocam,
            title: 'video_conversion'.tr(),
            subtitle:
                '${'days_ago'.tr(namedArgs: {'days': '2'})} • ${'min_duration'.tr(namedArgs: {'minutes': '8'})}'),
      ],
    );
  }
